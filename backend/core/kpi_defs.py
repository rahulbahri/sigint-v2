...
KPI_DEFS = [
    {"key": "revenue_growth",       "name": "Revenue Growth Rate",       "unit": "pct",    "direction": "higher", "gaap_status": "gaap",     "formula": "(Revenue_Month - Revenue_PrevMonth) / Revenue_PrevMonth × 100"},
    {"key": "gross_margin",         "name": "Gross Margin %",            "unit": "pct",    "direction": "higher", "gaap_status": "gaap",     "formula": "(Revenue - COGS) / Revenue × 100"},
    {"key": "operating_margin",     "name": "Operating Margin %",        "unit": "pct",    "direction": "higher", "gaap_status": "gaap",     "formula": "(Revenue - COGS - OpEx) / Revenue × 100"},
    {"key": "ebitda_margin",        "name": "EBITDA Margin %",           "unit": "pct",    "direction": "higher", "gaap_status": "gaap",     "formula": "EBITDA / Revenue × 100"},
    {"key": "cash_conv_cycle",      "name": "Cash Conversion Cycle",     "unit": "days",   "direction": "lower",  "gaap_status": "operating","formula": "DSO + DIO - DPO",                                          "domain": "cashflow"},
    {"key": "dso",                  "name": "Days Sales Outstanding",    "unit": "days",   "direction": "lower",  "gaap_status": "operating","formula": "(AR / Revenue) × 30",                                         "domain": "cashflow"},
    {"key": "ar_turnover",          "name": "AR Turnover Ratio",         "unit": "ratio",  "direction": "higher", "gaap_status": "operating","formula": "Net_Credit_Sales / Average_AR",                               "domain": "cashflow"},
    {"key": "avg_collection_period","name": "Avg Collection Period",     "unit": "days",   "direction": "lower",  "gaap_status": "operating","formula": "365 / AR_Turnover_Ratio",                                     "domain": "cashflow"},
    {"key": "cei",                  "name": "Collections Effectiveness", "unit": "pct",    "direction": "higher", "gaap_status": "operating","formula": "(Beg_AR + Sales - End_AR) / (Beg_AR + Sales - Current_AR) × 100", "domain": "cashflow"},
    {"key": "ar_aging_current",     "name": "AR Current (0-30 days)",    "unit": "pct",    "direction": "higher", "gaap_status": "operating","formula": "Current_AR / Total_AR × 100",                                 "domain": "cashflow"},
    {"key": "ar_aging_overdue",     "name": "AR Overdue (30+ days)",     "unit": "pct",    "direction": "lower",  "gaap_status": "operating","formula": "Overdue_AR / Total_AR × 100",                                 "domain": "cashflow"},
    {"key": "billable_utilization", "name": "Billable Utilization Rate", "unit": "pct",    "direction": "higher", "gaap_status": "operating","formula": "Billable_Hours / Total_Available_Hours × 100",                "domain": "efficiency"},
    {"key": "arr_growth",           "name": "ARR Growth Rate",           "unit": "pct",    "direction": "higher", "gaap_status": "non_gaap", "formula": "(ARR_Month - ARR_PrevMonth) / ARR_PrevMonth × 100"},
    {"key": "nrr",                  "name": "Net Revenue Retention",     "unit": "pct",    "direction": "higher", "gaap_status": "non_gaap", "formula": "(MRR_Start + Expansion - Churn - Contraction) / MRR_Start × 100"},
    {"key": "burn_multiple",        "name": "Burn Multiple",             "unit": "ratio",  "direction": "lower",  "gaap_status": "non_gaap", "formula": "Net Burn / Net New ARR"},
    {"key": "opex_ratio",           "name": "Operating Expense Ratio",   "unit": "pct",    "direction": "lower",  "gaap_status": "gaap",     "formula": "OpEx / Revenue × 100"},
    {"key": "contribution_margin",  "name": "Contribution Margin %",     "unit": "pct",    "direction": "higher", "gaap_status": "gaap",     "formula": "(Revenue - COGS - Variable_Costs) / Revenue × 100"},
    {"key": "revenue_quality",      "name": "Revenue Quality Ratio",     "unit": "pct",    "direction": "higher", "gaap_status": "non_gaap", "formula": "Recurring_Revenue / Total_Revenue × 100"},
    {"key": "cac_payback",          "name": "CAC Payback Period",        "unit": "months", "direction": "lower",  "gaap_status": "operating","formula": "CAC / (ARPU × Gross_Margin_pct)"},
    {"key": "sales_efficiency",     "name": "Sales Efficiency Ratio",    "unit": "ratio",  "direction": "higher", "gaap_status": "operating","formula": "New_ARR / Sales_Marketing_Spend"},
    {"key": "customer_concentration","name":"Customer Concentration",    "unit": "pct",    "direction": "lower",  "gaap_status": "operating","formula": "Top_Customer_Revenue / Total_Revenue × 100"},
    {"key": "recurring_revenue",    "name": "Recurring Revenue Ratio",   "unit": "pct",    "direction": "higher", "gaap_status": "non_gaap", "formula": "Recurring_Revenue / Total_Revenue × 100"},
    {"key": "churn_rate",           "name": "Monthly Churn Rate",        "unit": "pct",    "direction": "lower",  "gaap_status": "operating","formula": "Lost_Customers / Total_Customers × 100"},
    {"key": "operating_leverage",   "name": "Operating Leverage Index",  "unit": "ratio",  "direction": "higher", "gaap_status": "gaap",     "formula": "% Change in Operating Income / % Change in Revenue"},
